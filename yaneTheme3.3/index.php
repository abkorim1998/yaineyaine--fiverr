...
<html lang="en">
    ...
    <div class="footerSection">
        ...
        <div class="shaerItem">
            <ul>
                <li><i class="fab fa-facebook-f"></i><a class="fbsharelink" data-shareurl="www.google.com">Facebook</a></li>
                <li><i class="fab fa-twitter"></i><a id="twittershare"  href="www.google.com">Tweet</a></li>
                <li><i class="fab fa-google-plus-g"></i><a class="fbsharelink" data-shareurl="www.google.com">Google+</a></li>
                <li><i class="fab fa-pinterest"></i><a class="fbsharelink" data-shareurl="www.google.com">Pinterest</a></li>
                <li><i class="fab fa-tumblr"></i><a class="fbsharelink" data-shareurl="www.google.com">Tumblr</a></li>
                <li><i class="fab fa-vk"></i><a class="fbsharelink" data-shareurl="www.google.com">Vk</a></li>
            </ul>
        </div>
